...
doc_events = {
	"Bin": { "autoname": "excel_erpnext.overrides.doctype_overrides.autoname" },
	"Delivery Note": { "autoname": "excel_erpnext.overrides.doctype_overrides.autoname" },
	"GL Entry": { "autoname": "excel_erpnext.overrides.doctype_overrides.autoname" },
	"Stock Entry": { "autoname": "excel_erpnext.overrides.doctype_overrides.autoname" },
	"Sales Invoice": { "autoname": "excel_erpnext.overrides.doctype_overrides.autoname" },
}
